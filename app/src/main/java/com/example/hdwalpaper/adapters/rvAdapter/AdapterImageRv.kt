...
import com.example.hdwalpaper.databinding.ItemImage1Binding
import com.example.hdwalpaper.databinding.ItemImageBinding
import com.squareup.picasso.Picasso

class AdapterImageRv(var onItemClickListener: OnItemClickListener):PagingDataAdapter<com.example.hdwalpaper.models.Result,AdapterImageRv.Vh>(MyDiffUtill()) {
    inner class Vh(var itemImageBinding: ItemImage1Binding):RecyclerView.ViewHolder(itemImageBinding.root){
...
//            }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Vh {
        return Vh(ItemImage1Binding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
